...
=end
  ...
  def get_temp_details(person)
    ...
    person.mother_residential_country = session[:temp_person_details]['mother_country']
    person.mother_residential_district = session[:temp_person_details]['mother_physical_district']
    person.mother_residential_ta = session[:temp_person_details]['mother_physical_ta']
    person.mother_residential_village = session[:temp_person_details]['mother_physical_village']
    person.mother_home_country = session[:temp_person_details]['mother_country']
    ...
    person.gestation_at_birth = session[:temp_person_details]['gestation_age']
    person.number_of_prenatal_visits = session[:temp_person_details]['prenatal_visits_number']
    person.month_prenatal_care_started = session[:temp_person_details]['prenatal_care_began']
    person.mode_of_delivery = session[:temp_person_details]['delivery_mode']
    person.number_of_children_born_alive_inclusive = session[:temp_person_details]['born_alive_number']
    person.number_of_children_born_still_alive = session[:temp_person_details]['born_alive_number_living']
    ...
    person.father_residential_country = session[:temp_person_details]['father_country']
    person.father_residential_district = session[:temp_person_details]['father_physical_district']
    person.father_residential_ta = session[:temp_person_details]['father_physical_ta']
    person.father_residential_village = session[:temp_person_details]['father_physical_village']
    person.father_home_country = session[:temp_person_details]['father_country']
