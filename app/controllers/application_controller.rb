class ApplicationController < ActionController::Base
  ...
  before_action :check_user, :except => ['logout', 'login']
  before_action :set_current_location, :except =>['set_current', 'districts', 'logout', 'login', 'tas', 'villages',"health_facilities"]
  before_action :current_location_to_readable, :except =>['set_current', 'districts', 'logout', 'login', 'tas', 'villages',"health_facilities"]
